...
def csvCreator(data, update_date):
	...
	new_data_in = open('../ppp_files/update_archive/json/' + update_date + '.json','r')
	new_data = json.load(new_data_in)

	# Create new CSV archive file for input month
	archive_csv = open('../ppp_files/update_archive/csv/' + update_date + '.csv', 'w')
	...
	full_csv = open('../ppp_files/full_data.csv','r')
	full_csv_reader = csv.reader(full_csv, delimiter=',', quotechar="'")

	# open new gender data csv write file
	new_gender_csv = open('../ppp_files/new_full_gender_data.csv', 'w')
	...
	gender_csv = open('../ppp_files/full_gender_data.csv','r')
